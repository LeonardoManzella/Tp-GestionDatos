...
CREATE TABLE kfc.USUARIOS
          (
                  ...
                  , us_nick VARCHAR(30) UNIQUE NOT NULL
                  , --No quiero poner valores muy grandes para evitar que pese mucho la base de datos y ande lenta, mejor que ande rapida para nosotros
